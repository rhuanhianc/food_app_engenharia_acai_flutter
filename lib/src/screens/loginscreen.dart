  ...
  Widget homePage() {
    return Center(
      child: new AspectRatio(
        ...
        children: <Widget>[
          Image.asset('images/wel.png', width: 220, height: 220),
          Container(
            margin: EdgeInsets.only(bottom: 10, top: 0),
            child: Text('Engenharia do Açaí' ,style: logoStyle),
          ),]),
              ),
              new Container(
              ...
              new Container(
                width: MediaQuery.of(context).size.width,
                margin: const EdgeInsets.only(left: 30.0, right: 30.0, top: 15.0, bottom: 10.0),
                alignment: Alignment.center,
                child: new Row(
                  children: <Widget>[
                    new Expanded(
    ...
    return new Container(
      ...
      child: new ListView(
        children: <Widget>[
          ...
          new Container(
            width: MediaQuery.of(context).size.width,
            margin: const EdgeInsets.only(left: 30.0, right: 30.0, top: 50.0, bottom: 10.0),
            alignment: Alignment.center,
            child: new Row(
              children: <Widget>[
                new Expanded(
